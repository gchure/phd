...
traces = pd.read_csv("../../data/csv/complete_mcmc_traces.csv")
...
ax[0].set_title(
    "slow shock (< 1.0 Hz)", backgroundcolor=colors["pale_yellow"], fontsize=8, y=1.04
)
ax[1].set_title(
    "fast shock (≥ 1.0 Hz)", backgroundcolor=colors["pale_yellow"], fontsize=8, y=1.1
)
